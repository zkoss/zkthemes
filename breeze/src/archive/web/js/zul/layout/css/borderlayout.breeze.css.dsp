...
.z-borderlayout-icon {
	...
	background-image : url(${c:encodeURL('~./zul/img/breeze/layout/borderlayout-btn.png')});
	margin-left: 2px;
	cursor: pointer;
}
...
.z-south-header {
	...
	background-image: url(${c:encodeURL('~./zul/img/breeze/layout/borderlayout-hm.png')});
	white-space: nowrap;
	overflow: hidden;
	line-height: 15px;
	zoom: 1;
...
.z-borderlayout-icon {
	background-image : url(${c:encodeURL('~./zul/img/breeze/layout/borderlayout-btn.gif')});
}
.z-west-splt-btn {
