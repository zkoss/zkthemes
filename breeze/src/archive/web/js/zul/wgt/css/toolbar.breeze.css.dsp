...
.z-toolbar {
	...
	display: block;
	padding: 2px;
	background: #DAF3FF repeat-x 0 -1px;
	background-image: url(${c:encodeURL('~./zul/img/breeze/common/toolbar-hm.png')});
...
.z-toolbarbutton .z-toolbarbutton-br{
	background-image:url(${c:encodeURL('~./zul/img/breeze/button/toolbarbtn-corner.gif')});
}
.z-toolbarbutton .z-toolbarbutton-tm, 
.z-toolbarbutton .z-toolbarbutton-bm  {
	background-image:url(${c:encodeURL('~./zul/img/breeze/button/toolbarbtn-x.gif')});
}
.z-toolbarbutton .z-toolbarbutton-cl, 
.z-toolbarbutton .z-toolbarbutton-cr {
	background-image:url(${c:encodeURL('~./zul/img/breeze/button/toolbarbtn-y.gif')});
}
