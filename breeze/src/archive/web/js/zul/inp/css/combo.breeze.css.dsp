...
.z-combobox-rounded-inp {
	background-image: url(${c:encodeURL('~./zul/img/breeze/button/combobox-rounded.png')});
}
.z-bandbox-rounded-inp {
	background-image: url(${c:encodeURL('~./zul/img/breeze/button/bandbox-rounded.png')});
}
.z-datebox-rounded-inp {
	background-image: url(${c:encodeURL('~./zul/img/breeze/button/datebox-rounded.png')});
}
.z-timebox-rounded-inp,
.z-spinner-rounded-inp,
.z-doublespinner-rounded-inp {
	background-image: url(${c:encodeURL('~./zul/img/breeze/button/timebox-rounded.png')});	
}
...
.z-doublespinner .z-doublespinner-btn {
	...
	background-image : url(${c:encodeURL('~./zul/img/breeze/input/combobtn.gif')});
	vertical-align: top; 
	cursor: pointer; 
	width: 19px; 
	height: 20px; 
...
.z-spinner .z-spinner-btn-upper,
.z-doublespinner .z-doublespinner-btn-upper {
	background-image: url(${c:encodeURL('~./zul/img/breeze/input/timebtn-up.gif')});
...
.z-spinner .z-spinner-btn-lower,
.z-doublespinner .z-doublespinner-btn-lower {
	background-image: url(${c:encodeURL('~./zul/img/breeze/input/timebtn-down.gif')});
...
<%-- Bandbox trendy mold --%>
.z-bandbox .z-bandbox-btn {
	background-image: url(${c:encodeURL('~./zul/img/breeze/input/bandbtn.gif')});
}
<%-- Datebox --%>
...
.z-datebox .z-datebox-btn {
	background-image : url(${c:encodeURL('~./zul/img/breeze/input/datebtn.gif')});
}
.z-datebox-rounded-pp,
.z-datebox-pp {
...
.z-combobox-rounded .z-combobox-rounded-btn,
.z-combobox-rounded-readonly {
	background-image: url(${c:encodeURL('~./zul/img/breeze/button/combobox-rounded.gif')});
}
.z-bandbox-rounded-inp,
.z-bandbox-rounded .z-bandbox-rounded-btn,
.z-bandbox-rounded-readonly {
	background-image: url(${c:encodeURL('~./zul/img/breeze/button/bandbox-rounded.gif')});
}
.z-datebox-rounded-inp,
.z-datebox-rounded .z-datebox-rounded-btn,
.z-datebox-rounded-readonly {
	background-image: url(${c:encodeURL('~./zul/img/breeze/button/datebox-rounded.gif')});
}
.z-timebox-rounded-inp,
.z-spinner-rounded-inp,
.z-doublespinner-rounded-inp,
...
.z-spinner-rounded-readonly,
.z-doublespinner-rounded-readonly {
	background-image: url(${c:encodeURL('~./zul/img/breeze/button/timebox-rounded.gif')});	
}
</c:if>
<%-- Gecko --%>
<c:if test="${c:isGecko()}">
