...
.z-panel-br {
	...
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/panel-corner.png')});
	margin-right: 7px;
	height: 7px;
	font-size: 0;
	line-height: 0;
...
.z-panel-tr-gray {
	...
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/panel-corner-blue.png')});
}
.z-panel-bl {
...
.z-panel-header {
	...
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/panel-hm.png')});
...
.z-panel-hl {
	...
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/panel-hl.png')});
	padding-left: 7px;
...
.z-panel-hr {
	...
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/panel-hr.png')});
	padding-right: 7px;
	zoom: 1;
}
<%-- Header Middle --%>
...
.z-panel-fl {
	...
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/panel-clr.png')});
	padding-left: 4px;
	zoom: 1;
}
...
.z-panel-bl,
.z-panel-br {
	background-image:url(${c:encodeURL('~./zul/img/breeze/wnd/panel-corner.gif')});
}
.z-panel-tl-gray,
.z-panel-tr-gray{
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/panel-corner-blue.gif')});
}
.z-panel-icon {
