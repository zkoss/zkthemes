...
.z-window-popup-tl {
	...
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-ol-corner.png')});
	margin-right: 5px;
	height: 5px;
	font-size: 0;
	line-height: 0;
...
.z-window-embedded-tl {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-corner.png')});
}
.z-window-popup-tl {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-pop-corner.png')});
}
<%-- Top Right Corner --%>
...
.z-window-popup-hl {
	...
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-ol-hl.png')});
	padding-left: 6px;
	zoom: 1;
}
.z-window-embedded-hl{
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-hl.png')});
}
.z-window-popup-hl {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-pop-hl.png')});
}
<%-- Header Right --%>
...
.z-window-overlapped-hr,
 .z-window-popup-hr {
	...
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-ol-hr.png')});
	padding-right: 6px;
	zoom: 1;
}
.z-window-embedded-hr, .z-window-embedded-hr-noborder {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-hr.png')});
}
.z-window-popup-hr {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-pop-hr.png')});
}
<%-- Header Middle --%>
...
.z-window-popup-hm {
	...
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-ol-hm.png')});
	overflow: hidden;
	zoom: 1;
}
<%-- Header --%>
...
.z-window-overlapped-cl {
	...
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-ol-clr.png')});
	padding-left: 6px;
	zoom: 1;
}
<%-- Center Right --%>
...
.z-window-embedded-hm{
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-hm.png')});
}
...
.z-window-embedded-cr {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-clr.png')});
}
...
.z-window-highlighted-icon {
	background: transparent no-repeat 0 0;
	background-image : url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-icon.png')});
	height: 17px;
	width: 28px;
	overflow: hidden;
	float: right;
...
.z-window-highlighted-bl,
.z-window-highlighted-br {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-ol-corner.gif')});
}
.z-window-embedded-tl,
.z-window-embedded-tr {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-corner.gif')});
}
.z-window-popup-tl,
.z-window-popup-tr {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-pop-corner.gif')});
}
.z-window-modal-hl,
.z-window-highlighted-hl,
.z-window-overlapped-hl {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-ol-hl.gif')});
}
.z-window-modal-hr,
.z-window-highlighted-hr,
.z-window-overlapped-hr {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-ol-hr.gif')});
}
.z-window-embedded-hl,
.z-window-embedded-hl-noborder {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-hl.gif')});
}
.z-window-embedded-hr,
.z-window-embedded-hr-noborder {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-hr.gif')});
}
.z-window-popup-hr {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-ol-hr.gif')});
}
...
.z-window-overlapped-hm,
.z-window-popup-hm {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-ol-hm.gif')});
}
.z-window-embedded-hm,
.z-window-embedded-hm-noborder {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-hm.gif')});
}
.z-window-popup-hm {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-pop-hm.gif')});
}
...
.z-window-overlapped-cl,  .z-window-overlapped-cr {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-ol-clr.gif')});
}
.z-window-overlapped-tl, .z-window-overlapped-tr,
.z-window-popup-tl,      .z-window-popup-tr,
.z-window-overlapped-bl, .z-window-overlapped-br {
...
.z-window-embedded-cl, 
.z-window-embedded-cr {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-clr.gif')});
}
.z-window-embedded-bl,
.z-window-embedded-br {
	background-image: url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-corner.gif')});
...
.z-window-popup-icon,
.z-window-overlapped-icon {
	background-image : url(${c:encodeURL('~./zul/img/breeze/wnd/wnd-icon.gif')});
}
.z-msgbox-question {
