...
.z-groupbox .z-groupbox-hl {
	...
	background-image:url(${c:encodeURL('~./sapphire/zul/img/layout/groupbox-y.gif')});
}
...
.z-groupbox-hm {
	background: no-repeat;
	background-position: 0 center;
	background-image:url(${c:encodeURL('~./sapphire/zul/img/layout/groupbox-x.gif')});
}
...
.z-groupbox-3d-hm {
	...
	background-image:url(${c:encodeURL('~./sapphire/zul/img/layout/groupbox-hm.png')});
	overflow: hidden;
