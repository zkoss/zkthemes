...
div.z-tree {
	...
	background-image: url(${c:encodeURL('~./sapphire/zul/img/grid/column-bg.png')});
}
...
span.z-tree-root-close, span.z-tree-tee-close, span.z-tree-last-close {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/arrow-toggle.png')});
}
span.z-tree-root-open, span.z-tree-tee-open, span.z-tree-last-open {
...
div.z-tree-header th.z-treecol-sort-over {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/grid/header-over.png')});
}
div.z-treecol-cnt {
	position: relative;
}
...
.z-treecol-sort-dsc .z-treecol-sort-img {
	background-position: 0 0;
    background-repeat: no-repeat;
	background-image: url(${c:encodeURL('~./sapphire/zul/img/grid/arrows.png')});
}
...
tr.z-treerow-seld {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/item-sel.png')});
	<c:if test="${zk.ie == 6}">
...
.z-vfiletree-header-bg {
	...
	height: 1px;
	font-size: 0;
	background-image: url(${c:encodeURL('~./sapphire/zul/img/grid/head-bg.png')});
	margin-top: -1px;
}
...
span.z-dottree-root-open, span.z-dottree-root-close {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/dot-toggle.gif')});
}
...
span.z-dottree-tee-open {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/tee-open.gif')});
}
span.z-dottree-tee-close {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/tee-close.gif')});
}
span.z-dottree-last-open {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/tee-last-open.gif')});
}
span.z-dottree-last-close {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/tee-last-close.gif')});
}
span.z-dottree-tee {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/tee.gif')});
}
span.z-dottree-vbar {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/tee-vbar.gif')});
}
span.z-dottree-last {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/tee-last.gif')});
}
...
span.z-filetree-ico,span.z-filetree-firstspacer {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/folder-toggle.gif')});
}
...
span.z-filetree-tee, span.z-filetree-last {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/entity.gif')});
}
...
span.z-vfiletree-ico,span.z-vfiletree-firstspacer {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/vfolder-toggle.png')});
}
...
span.z-vfiletree-tee, span.z-vfiletree-last {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/ventity.png')});
}
...
span.z-vfiletree-ico, span.z-vfiletree-firstspacer {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/vfolder-toggle.gif')});
}
span.z-vfiletree-tee, span.z-vfiletree-last {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/ventity.gif')});
}
span.z-tree-root-open, span.z-tree-tee-open, span.z-tree-last-open,
span.z-tree-root-close, span.z-tree-tee-close, span.z-tree-last-close {
	background-image: url(${c:encodeURL('~./sapphire/zul/img/tree/arrow-toggle.gif')});
}
</c:if>
</c:if>
...
.z-treerow-img-checkbox, .z-treerow-img-radio {
	background-image:url(${c:encodeURL('~./sapphire/zul/img/common/check-sprite.gif')});
	background-position: 0 0;
}
.z-treerow-img-radio {
