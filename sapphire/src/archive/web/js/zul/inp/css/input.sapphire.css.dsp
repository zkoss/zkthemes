...
.z-doublebox-rounded-inp {
	...
	border: 0;
	padding: 5px 4px;
	background-image: url(${c:encodeURL('~./zul/img/sapphire/button/timebox-rounded.png')});
...
.z-errbox-left {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/error-icon.png')});
...
.z-pointer-d {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerD.png')});
	height: 6px;
}
.z-pointer-u {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerU.png')});
	height: 6px;
}
.z-pointer-l {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerL.png')});
	width: 6px;
}
.z-pointer-r {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerR.png')});
	width: 6px;
}
.z-pointer-ld {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerLD.png')});
}
.z-pointer-lu {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerLU.png')});
}
.z-pointer-rd {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerRD.png')});
}
.z-pointer-ru {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerRU.png')});
}

.z-errbox-close, .z-errbox-close-over {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/error-close.gif')});
	zoom: 1; <%--Bug 2916148 --%>
}
.z-errbox-close-over {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/error-close-over.gif')});
}
...
.z-pointer-d {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerD.gif')});
}
.z-pointer-l {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerL.gif')});
}
.z-pointer-ld {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerLD.gif')});
}
.z-pointer-lu {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerLU.gif')});
}
.z-pointer-rd {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerRD.gif')});
}
.z-pointer-ru {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerRU.gif')});
}
.z-pointer-r {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerR.gif')});
}
.z-pointer-u {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/pointerU.gif')});
}
.z-errbox-left {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/errbox/error-icon.gif')});
}
.z-popup .z-popup-cl {
	background: transparent repeat-x 0 0;
