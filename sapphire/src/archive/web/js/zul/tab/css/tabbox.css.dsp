...
.z-tab-close,
.z-tab-ver-close {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/tab-close.gif')});
...
.z-tab-hl {
	...
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/tab-corner.png')});
	-moz-outline: none;
	outline: none;
	cursor: pointer;
}
...
.z-tab-hm {
	...
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/tab-hm.png')});
}
.z-tab-hm-close {
	padding-right: 10px;
}
...
.z-tabs-scroll .z-tabs-left-scroll {
	...
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/scroll-r.png')});
	border-bottom: 1px solid #E1E1E1;
	cursor: pointer;
	position: absolute;
	z-index: 25;
...
.z-tabs-scroll .z-tabs-left-scroll {
	...
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/scroll-l.png')});
}
...
.z-tab-ver-hl {
	...
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/tab-v-corner.png')});
	cursor: pointer;
}
...
.z-tab-ver .z-tab-ver-hm {
	...
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/tab-v-hm.png')});
	zoom: 1;
}
...
.z-tabs-ver-up-scroll-hl {
	...
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/scroll-u.png')});
	border-right: 1px solid #E1E1E1;
}
.z-tabs-ver-up-scroll {
	top: 0;
...
.z-tabs-ver-down-scroll-hl {
	background: transparent no-repeat center bottom;
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/scroll-d.png')});
	border-right: 1px solid #E1E1E1;
}
.z-tabs-ver-down-scroll {
	bottom: 0;
...
.z-tabs-ver-up-scroll-hl{
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/scroll-u-hl.png')});
}
.z-tabs-ver-down-scroll-hl {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/scroll-d-hl.png')});
}
...
.z-tab-accordion-hm {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/accd-hm.png')});
	overflow: hidden;
	padding: 5px 0 3px;
	zoom: 1;
}
.z-tab-accordion-hm:hover {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/accd-hm-mouseover.png')});
}
...
<c:if test="${c:browser('ie6-')}">
.z-tab-hl, .z-tab-hr {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/tab-corner.gif')});
}
.z-tab-hm {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/tab-hm.gif')});
}
.z-tab-ver-hl, .z-tab-ver-hl .z-tab-ver-hr {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/tab-v-corner.gif')});
}
.z-tab-ver .z-tab-ver-hm {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tab/tab-v-hm.gif')});
}
.z-toolbar-tabs {
	height: 20px;
}
