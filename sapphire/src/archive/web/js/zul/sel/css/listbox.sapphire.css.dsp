...
tr.z-listgroup-over {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/grid/group-bg-over.png')});
}
tr.z-listgroup-seld {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/grid/group-bg-seld.png')});
}
tr.z-listgroup-over-seld {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/grid/group-bg-over-seld.png')});
}
...
div.z-listbox-header th.z-listheader.z-listheader-sizing, div.z-listbox-header th.z-listheader.z-listheader-sizing div.z-listheader-cnt {
	cursor: e-resize;
}
...
div.z-listbox-header th.z-listheader-sort-over {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/grid/header-over.png')});
}
...
.z-listbox-header-bg {
	...
	height: 1px;
	font-size: 0;
	background-image: url(${c:encodeURL('~./zul/img/sapphire/grid/head-bg.png')});
	margin-top: -1px;
}
...
.z-listheader-sort-dsc .z-listheader-sort-img {
	background-position: 0 0;
    background-repeat: no-repeat;
	background-image: url(${c:encodeURL('~./zul/img/sapphire/grid/arrows.png')});
}
...
.z-listgroup-img-radio,
.z-listgroupfoot-img {
	background-image:url(${c:encodeURL('~./zul/img/sapphire/common/check-sprite.gif')});
	background-position: 0 0;
}
.z-listitem-img-radio,
.z-listgroup-img-radio {
