...
span.z-tree-root-close, span.z-tree-tee-close, span.z-tree-last-close {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tree/arrow-toggle.png')});
}
span.z-tree-root-open, span.z-tree-tee-open, span.z-tree-last-open {
...
tr.z-treerow-seld {
	background-image: url(${c:encodeURL('~./zul/img/sapphire/tree/item-sel.png')});
	<c:if test="${c:browser('ie6-')}">
		background-image: url(${c:encodeURL('~./zul/img/sapphire/tree/item-sel.gif')});
	</c:if>
