...
.z-menubar-hor,.z-menubar-ver {
	...
	background-image: url(${c:encodeURL('~./zul/img/sapphire/menu/menu-bg.png')});
}
.z-menubar-ver {
...
.z-menubar-hor .z-menu-body-clk .z-menu-inner-m  div {
	...
	background-image:url(${c:encodeURL('~./zul/img/sapphire/menu/btn-arrow.gif')});
}
.z-menubar-hor .z-menu-body-clk .z-menu-inner-m  div,
...
.z-menu-item-body-over .z-menu-item-inner-r {
	...
	background-image : url(${c:encodeURL('~./zul/img/sapphire/menu/menu-btn.png')});
}
.z-menu-body-over .z-menu-inner-r,
.z-menu-item-body-over .z-menu-item-inner-r {
...
.z-menubar-hor .z-menu-body-clk-over .z-menu-inner-m  div {
	...
	background-image:url(${c:encodeURL('~./zul/img/sapphire/menu/btn-menu-hor-over.gif')});
}
.z-menubar-ver .z-menu-body-clk-over .z-menu-inner-m  div {
	background: transparent no-repeat right 0;
	background-image:url(${c:encodeURL('~./zul/img/sapphire/menu/btn-menu-ver-over.gif')});
}
<%-- seld effect --%>
.z-menu-body-seld .z-menu-inner-l,
.z-menu-body-seld .z-menu-inner-r {
	background:  url(${c:encodeURL('~./zul/img/sapphire/menu/menu-btn.png')}) no-repeat transparent 0 -120px;
}
.z-menu-body-seld .z-menu-inner-r {
...
.z-menu-popup .z-menu-popup-cnt{
	...
	background-image : url(${c:encodeURL('~./zul/img/sapphire/menu/pp-bg.png')});
	border:0 none;
	padding:0;
	margin:0 !important;
	overflow:hidden;
...
.z-menu-popup-cnt .z-menu .z-menu-cnt-img {
	...
	background-image:url(${c:encodeURL('~./zul/img/sapphire/menu/arrow.gif')});
}
<%--define checked menuitem effect in menupopup --%>
.z-menu-popup-cnt .z-menu-item-cnt-ck .z-menu-item-img {
	background:transparent no-repeat center center;
	background-image:url(${c:encodeURL('~./zul/img/sapphire/menu/checked.gif')});
}
.z-menu-popup-cnt .z-menu-item-cnt-unck .z-menu-item-img {
	background:transparent no-repeat center center;
	background-image:url(${c:encodeURL('~./zul/img/sapphire/menu/unchecked.gif')});
}
...
.z-menu-popup-cnt .z-menu-over .z-menu-cm {
	background-repeat : no-repeat;
	background-position : 0 0;
	background-image : url(${c:encodeURL('~./zul/img/sapphire/menu/trans-menu-btn.png')});
}
