...
.z-toolbar {
	...
	background-image: url(${c:encodeURL('~./zul/img/sapphire/common/toolbar-hm.png')});
...
.z-toolbarbutton .z-toolbarbutton-br{
	background-image:url(${c:encodeURL('~./zul/img/sapphire/button/toolbarbtn-corner.gif')});
}
.z-toolbarbutton .z-toolbarbutton-tm, 
.z-toolbarbutton .z-toolbarbutton-bm  {
	background-image:url(${c:encodeURL('~./zul/img/sapphire/button/toolbarbtn-x.gif')});
}
.z-toolbarbutton .z-toolbarbutton-cl, 
.z-toolbarbutton .z-toolbarbutton-cr {
	background-image:url(${c:encodeURL('~./zul/img/sapphire/button/toolbarbtn-y.gif')});
}
.z-toolbarbutton .z-toolbarbutton-cm {
	background-image:url(${c:encodeURL('~./zul/img/sapphire/button/toolbarbtn-ctr.gif')});
}
