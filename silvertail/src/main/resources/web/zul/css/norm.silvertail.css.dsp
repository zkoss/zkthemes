...
span.z-drop-allow {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/misc/drag-allow.png')});
}
span.z-drop-disallow {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/misc/drag-disallow.png')});
}
div.z-drop-ghost {
...
span.z-drop-allow {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/misc/drag-allow.gif')});
}
span.z-drop-disallow {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/misc/drag-disallow.gif')});
}
</c:if><%-- IE6 --%>
</c:if><%--IE --%>
