...
tr.z-listgroup {
	...
	background-image: url(${c:encodeURL('~./zul/img/silvertail/grid/group_bg.gif')});
}
tr.z-listgroup-over {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/grid/group-bg-over.png')});
}
tr.z-listgroup-seld {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/grid/group-bg-seld.png')});
}
tr.z-listgroup-over-seld {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/grid/group-bg-over-seld.png')});
}
...
.z-listgroup-img {
	...
	background-image: url(${c:encodeURL('~./zul/img/silvertail/tree/arrow-toggle.gif')});
...
.z-listgroupfoot{
	height: 25px;
	background-image: url(${c:encodeURL('~./zul/img/silvertail/grid/groupfoot_bg.gif')});
}
...
div.z-listbox-header th.z-listheader-sort-over {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/grid/header-over.png')});
}
...
.z-listheader-sort-dsc .z-listheader-sort-img {
	background-position: 0 0;
    background-repeat: no-repeat;
	background-image: url(${c:encodeURL('~./zul/img/silvertail/grid/arrows.png')});
}
...
.z-listgroup-img-radio,
.z-listgroupfoot-img {
	background-image:url(${c:encodeURL('~./zul/img/silvertail/common/check-sprite.gif')});
	background-position: 0 0;
}
.z-listitem-img-radio,
.z-listgroup-img-radio {
