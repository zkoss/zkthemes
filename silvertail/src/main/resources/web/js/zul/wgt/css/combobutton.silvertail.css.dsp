...
.z-combobutton-over tr td,
.z-combobutton-focus tr td,
.z-combobutton-clk tr td {
	color: #252525;
}
...
.z-combobutton .z-combobutton-bl {
	background-image:url(${c:encodeURL('~./zul/img/silvertail/button/btn-corner.gif')});
}
.z-combobutton .z-combobutton-tr,
.z-combobutton .z-combobutton-br {
	background-image:url(${c:encodeURL('~./zul/img/silvertail/button/combobutton-corner-r.gif')});
}
.z-combobutton .z-combobutton-tm, .z-combobutton .z-combobutton-bm  {
	background-image:url(${c:encodeURL('~./zul/img/silvertail/button/btn-x.gif')});
}
.z-combobutton .z-combobutton-cl {
	background-image:url(${c:encodeURL('~./zul/img/silvertail/button/btn-y.gif')});
}
.z-combobutton .z-combobutton-cr {
	background-image:url(${c:encodeURL('~./zul/img/silvertail/button/combobutton-y-r.gif')});
}
.z-combobutton .z-combobutton-cm {
	background-image:url(${c:encodeURL('~./zul/img/silvertail/button/btn-ctr.gif')});
}
