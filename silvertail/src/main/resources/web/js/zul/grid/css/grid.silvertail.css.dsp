...
.z-column-btn {
	...
	right: 0;
	width: 23px;
	background: url(${c:encodeURL('~./zul/img/silvertail/grid/hd-btn.png')}) no-repeat scroll left 0 transparent;
	background-position: 0 0;
}
...
tr.z-row-over > td.z-row-inner, tr.z-row-over > .z-cell {
	background-image:url(${c:encodeURL('~./zul/img/silvertail/grid/column-over.png')});
}
...
.z-column-sort-asc .z-column-sort-img,
.z-column-sort-dsc .z-column-sort-img {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/grid/arrows.gif')});
}
</c:if>
