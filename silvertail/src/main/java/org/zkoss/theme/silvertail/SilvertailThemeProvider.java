...
{{IS_NOTE
	...
	History:
		Mar 30, 2011 7:00:33 PM , Created by sam
}}IS_NOTE
 ...
 *
 */
public class SilvertailThemeProvider implements ThemeProvider {

	private final static String CLASSICBLUE_NAME = SilvertailThemeWebAppInit.CLASSICBLUE_NAME;
	...
	private static String getThemeFileSuffix() {
		...
		return CLASSICBLUE_NAME.equals(suffix) ? null : suffix;
	}
