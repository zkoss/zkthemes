...
/**
 * A standard implementation of ThemeProvider, which works with the Breeze
 * series themes.
 * 
 * @author simonpai
 */
public class StandardThemeProvider implements
...
//		uris.add(getNormCSS(suffix));
	...
	public int getWCSCacheControl(Execution exec, String uri) {
		return 8760; // a year. (JVM will utilize it, don't have to count the
						// answer)
	}
