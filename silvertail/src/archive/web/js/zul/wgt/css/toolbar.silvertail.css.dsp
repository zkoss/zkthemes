...
.z-toolbar {
	...
	background-image: url(${c:encodeURL('~./zul/img/silvertail/common/toolbar-hm.png')});
...
.z-toolbarbutton .z-toolbarbutton-br{
	background-image:url(${c:encodeURL('~./zul/img/silvertail/button/toolbarbtn-corner.gif')});
}
.z-toolbarbutton .z-toolbarbutton-tm, 
.z-toolbarbutton .z-toolbarbutton-bm  {
	background-image:url(${c:encodeURL('~./zul/img/silvertail/button/toolbarbtn-x.gif')});
}
.z-toolbarbutton .z-toolbarbutton-cl, 
.z-toolbarbutton .z-toolbarbutton-cr {
	background-image:url(${c:encodeURL('~./zul/img/silvertail/button/toolbarbtn-y.gif')});
}
.z-toolbarbutton .z-toolbarbutton-cm {
	background-image:url(${c:encodeURL('~./zul/img/silvertail/button/toolbarbtn-ctr.gif')});
}
