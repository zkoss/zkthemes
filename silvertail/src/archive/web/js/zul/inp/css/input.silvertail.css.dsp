...
.z-doublebox-rounded-inp {
	...
	border: 0;
	padding: 5px 4px;
	background-image: url(${c:encodeURL('~./zul/img/silvertail/button/timebox-rounded.png')});
...
.z-errbox-left {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/error-icon.png')});
...
.z-pointer-d {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerD.png')});
	height: 6px;
}
.z-pointer-u {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerU.png')});
	height: 6px;
}
.z-pointer-l {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerL.png')});
	width: 6px;
}
.z-pointer-r {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerR.png')});
	width: 6px;
}
.z-pointer-ld {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerLD.png')});
}
.z-pointer-lu {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerLU.png')});
}
.z-pointer-rd {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerRD.png')});
}
.z-pointer-ru {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerRU.png')});
}

.z-errbox-close, .z-errbox-close-over {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/error-close.gif')});
	zoom: 1; <%--Bug 2916148 --%>
}
.z-errbox-close-over {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/error-close-over.gif')});
}
...
.z-pointer-d {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerD.gif')});
}
.z-pointer-l {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerL.gif')});
}
.z-pointer-ld {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerLD.gif')});
}
.z-pointer-lu {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerLU.gif')});
}
.z-pointer-rd {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerRD.gif')});
}
.z-pointer-ru {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerRU.gif')});
}
.z-pointer-r {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerR.gif')});
}
.z-pointer-u {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/pointerU.gif')});
}
.z-errbox-left {
	background-image: url(${c:encodeURL('~./zul/img/silvertail/errbox/error-icon.gif')});
}
.z-popup .z-popup-cl {
	background: transparent repeat-x 0 0;
