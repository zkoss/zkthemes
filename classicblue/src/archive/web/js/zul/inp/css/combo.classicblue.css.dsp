...
.z-doublespinner-inp {
	...
	font-size: ${fontSizeM};
	font-weight: normal;
	background: #FFF url(${c:encodeURL('~./zul/img/classicblue/misc/text-bg.gif')}) repeat-x 0 0;
...
.z-combobox-rounded-inp {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/button/combobox-rounded.gif')});
}
.z-bandbox-rounded-inp {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/button/bandbox-rounded.gif')});
}
.z-datebox-rounded-inp {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/button/datebox-rounded.gif')});
}
.z-timebox-rounded-inp,
.z-spinner-rounded-inp,
.z-doublespinner-rounded-inp {
...
.z-doublespinner .z-doublespinner-text-invalid {
	background: #FFF url(${c:encodeURL('~./zul/img/classicblue/misc/text-bg-invalid.gif')}) repeat-x 0 0;
...
.z-doublespinner-rounded input.z-doublespinner-rounded-text-invalid {
	background: #FFF url(${c:encodeURL('~./zul/img/classicblue/button/redcombo-rounded.gif')}) repeat-x 0 0;
}
...
.z-doublespinner .z-doublespinner-btn {
	...
	background-image : url(${c:encodeURL('~./zul/img/classicblue/button/combobtn.gif')});
...
<%-- Bandbox trendy mold --%>
.z-bandbox .z-bandbox-btn {
	background-image : url(${c:encodeURL('~./zul/img/classicblue/button/bandbtn.gif')});
}
<%-- Datebox --%>
...
.z-datebox .z-datebox-btn {
	background-image : url(${c:encodeURL('~./zul/img/classicblue/button/datebtn.gif')});
}
.z-datebox-rounded-pp,
.z-datebox-pp {
...
.z-spinner .z-spinner-btn,
.z-doublespinner .z-doublespinner-btn {
	background-image : url(${c:encodeURL('~./zul/img/classicblue/button/timebtn.gif')});
}
<%-- Shadow --%>
...
.z-combobox-focus .z-combobox-readonly {
	...
	background-image: url(${c:encodeURL('~./zul/img/classicblue/button/readonly-bg.gif')});
...
.z-bandbox-focus .z-bandbox-readonly,
.z-combobox-focus .z-combobox-readonly {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/button/readonly-focus-bg.gif')});
}
