...
.z-textbox, .z-decimalbox, .z-intbox, .z-longbox, .z-doublebox {
	...
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/text-bg.gif')});
...
.z-doublebox-text-invalid {
	background: #FFF repeat-x 0 0;
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/text-bg-invalid.gif')});
...
.z-doublebox-rounded-inp {
	...
	border: 0;
	padding: 5px 4px;
	background-image: url(${c:encodeURL('~./zul/img/classicblue/button/timebox-rounded.gif')});
}
...
.z-doublebox-rounded .z-doublebox-rounded-text-invalid {
	background: transparent repeat-x 0 0;
	background-image: url(${c:encodeURL('~./zul/img/classicblue/button/redcombo-rounded.gif')});
}
...
.z-doublebox-rounded-focus input.z-doublebox-rounded-text-invalid {
	...
	background-image: url(${c:encodeURL('~./zul/img/classicblue/button/redcombo-rounded.gif')}) !important;
}
...
.z-arrow-d {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowD.png')});
}
.z-arrow-l {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowL.png')});
}
.z-arrow-ld {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowLD.png')});
}
.z-arrow-lu {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowLU.png')});
}
.z-arrow-rd {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowRD.png')});
}
.z-arrow-ru {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowRU.png')});
}
.z-arrow-r {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowR.png')});
}
.z-arrow-u {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowU.png')});
}
.z-errbox-close {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/errbox/close.gif')});
	zoom: 1; <%--Bug 2916148 --%>
}
.z-errbox-close-over {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/errbox/close-over.gif')});
}
.z-errbox.z-popup .z-popup-tl,
.z-errbox.z-popup .z-popup-tr,
.z-errbox.z-popup .z-popup-bl,
.z-errbox.z-popup .z-popup-br {
	background-image:url(${c:encodeURL('~./zul/img/classicblue/errbox/pp-corner.png')});
}
.z-errbox.z-popup .z-popup-cm {
	background-color : #FDF2E7;
	background-image: url(${c:encodeURL('~./zul/img/classicblue/errbox/pp-cm.png')});
}
.z-errbox.z-popup .z-popup-cl,
.z-errbox.z-popup .z-popup-cr {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/errbox/pp-clr.png')});
}

<%-- IE 6 GIF  --%>
<c:if test="${c:browser('ie6-')}">
.z-arrow-d {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowD.gif')});
}
.z-arrow-l {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowL.gif')});
}
.z-arrow-ld {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowLD.gif')});
}
.z-arrow-lu {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowLU.gif')});
}
.z-arrow-rd {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowRD.gif')});
}
.z-arrow-ru {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowRU.gif')});
}
.z-arrow-r {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowR.gif')});
}
.z-arrow-u {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/arrowU.gif')});
}
div.z-errbox div.z-popup-tl,
div.z-errbox div.z-popup-tr,
div.z-errbox div.z-popup-bl,
div.z-errbox div.z-popup-br {
	background-image:url(${c:encodeURL('~./zul/img/classicblue/errbox/pp-corner.gif')});
}
div.z-errbox div.z-popup-cm {
	background-color : #FDF2E7;
	background-image: url(${c:encodeURL('~./zul/img/classicblue/errbox/pp-cm.gif')});
}
div.z-errbox div.z-popup-cl,
div.z-errbox div.z-popup-cr {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/errbox/pp-clr.gif')});
}
</c:if>
