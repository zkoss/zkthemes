...
.z-paging-os .z-paging-os-seld {
	...
	background-image:url(${c:encodeURL('~./zul/img/classicblue/grid/paging-os-seld.gif')});
}
...
.z-paging .z-paging-sep {
	...
	overflow:hidden;
	width:4px;
	background-image:url(${c:encodeURL('~./zul/img/classicblue/paging/pg-split.gif')});
}
.z-paging-inp {
...
.z-paging-btn .z-paging-next {
	...
	background-image:url(${c:encodeURL('~./zul/img/classicblue/paging/pg-btn.png')});
}
.z-paging-btn .z-paging-prev {
...
.z-paging-btn .z-paging-last,
.z-paging-btn .z-paging-first {	
	background-image:url(${c:encodeURL('~./zul/img/classicblue/paging/pg-btn.gif')});
}
</c:if>
