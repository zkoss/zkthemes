...
tr.z-listgroup-over {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/grid/group-bg-over.png')});
}
tr.z-listgroup-seld {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/grid/group-bg-seld.png')});
}
tr.z-listgroup-over-seld {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/grid/group-bg-over-seld.png')});
}
