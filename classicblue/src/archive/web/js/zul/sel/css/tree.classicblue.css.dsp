...
div.z-tree-header tr.z-treecols, div.z-tree-header tr.z-auxhead {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/grid/column-bg.png')});
}
...
span.z-tree-root-close, span.z-tree-tee-close, span.z-tree-last-close {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/common/toggle.gif')});
}
span.z-tree-root-open, span.z-tree-tee-open, span.z-tree-last-open {
...
div.z-vfiletree-header th.z-treecol-sort div.z-treecol-cnt {
	...
	background-image: url(${c:encodeURL('~./zul/img/classicblue/sort/v_hint.gif')});
}
...
div.z-vfiletree-header th.z-treecol-sort-asc div.z-treecol-cnt {
	cursor: pointer; padding-right: 9px;
	background: transparent no-repeat 99% center;
	background-image: url(${c:encodeURL('~./zul/img/classicblue/sort/v_asc.gif')});
}
...
div.z-vfiletree-header th.z-treecol-sort-dsc div.z-treecol-cnt {
	cursor: pointer; padding-right: 9px;
	background: transparent no-repeat 99% center;
	background-image: url(${c:encodeURL('~./zul/img/classicblue/sort/v_dsc.gif')});
}
<%-- Treerow --%>
...
tr.z-treerow td.z-treerow-focus {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/common/focusd.png')});
	background-repeat: no-repeat;
}
...
span.z-dottree-root-open, span.z-dottree-root-close{
	background-image: url(${c:encodeURL('~./zul/img/classicblue/tree/dot-toggle.gif')});
}
...
span.z-dottree-tee-open {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/tree/tee-open.gif')});
}
span.z-dottree-tee-close {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/tree/tee-close.gif')});
}
span.z-dottree-last-open {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/tree/tee-last-open.gif')});
}
span.z-dottree-last-close {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/tree/tee-last-close.gif')});
}
span.z-dottree-tee {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/tree/tee.gif')});
}
span.z-dottree-vbar {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/tree/tee-vbar.gif')});
}
span.z-dottree-last {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/tree/tee-last.gif')});
}
...
span.z-filetree-ico,span.z-filetree-firstspacer {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/tree/folder-toggle.gif')});
}
...
span.z-filetree-tee, span.z-filetree-last {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/tree/entity.gif')});
}
...
span.z-vfiletree-ico,span.z-vfiletree-firstspacer {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/tree/vfolder-toggle.png')});
}
...
span.z-vfiletree-tee, span.z-vfiletree-last {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/tree/ventity.png')});
}
...
tr.z-treerow td.z-treerow-focus {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/common/focusd.gif')});
}
span.z-vfiletree-ico, span.z-vfiletree-firstspacer {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/tree/vfolder-toggle.gif')});
}
span.z-vfiletree-tee, span.z-vfiletree-last {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/tree/ventity.gif')});
}
</c:if>
</c:if>
...
.z-treerow-img-checkbox, .z-treerow-img-radio {
	background-image:url(${c:encodeURL('~./zul/img/classicblue/common/check-sprite.gif')});
	background-position: 0 0;
}
.z-treerow-img-radio {
