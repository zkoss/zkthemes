...
.z-window-popup-tl {
	...
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-ol-corner.png')});
	margin-right: 5px;
	height: 5px;
	font-size: 0;
	line-height: 0;
...
.z-window-embedded-tl {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-corner.png')});
}
.z-window-popup-tl {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-pop-corner.png')});
}
<%-- Top Right Corner --%>
...
.z-window-popup-hl {
	...
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-ol-hl.png')});
	padding-left: 6px;
	zoom: 1;
}
.z-window-embedded-hl{
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-hl.png')});
}
.z-window-popup-hl {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-pop-hl.png')});
}
<%-- Header Right --%>
...
.z-window-overlapped-hr,
 .z-window-popup-hr {
	...
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-ol-hr.png')});
	padding-right: 6px;
	zoom: 1;
}
.z-window-embedded-hr, .z-window-embedded-hr-noborder {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-hr.png')});
}
.z-window-popup-hr {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-pop-hr.png')});
}
<%-- Header Middle --%>
...
.z-window-popup-hm {
	...
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-ol-hm.png')});
	overflow: hidden;
	zoom: 1;
}
.z-window-embedded-hm {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-hm.png')});
}
.z-window-popup-hm {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-pop-hm.png')});
}
<%-- Header --%>
...
.z-window-overlapped-cl {
	...
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-ol-clr.png')});
	padding-left: 6px;
	zoom: 1;
}
<%-- Center Right --%>
...
.z-window-embedded-icon {
	background-image : url(${c:encodeURL('~./zul/img/classicblue/wnd/ebd-btn.gif')});
}
.z-window-modal-icon,
.z-window-highlighted-icon,
.z-window-overlapped-icon {
	background-image : url(${c:encodeURL('~./zul/img/classicblue/wnd/ol-btn.gif')});
}
.z-window-popup-icon {
	background-image : url(${c:encodeURL('~./zul/img/classicblue/wnd/pop-btn.gif')});
}
...
.z-msgbox-question {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/msgbox/question-btn.png')});
}
.z-msgbox-exclamation {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/msgbox/warning-btn.png')});
}
.z-msgbox-information {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/msgbox/info-btn.png')});
}
.z-msgbox-error {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/msgbox/stop-btn.png')});
}
...
.z-window-highlighted-bl,
.z-window-highlighted-br {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-ol-corner.gif')});
}
.z-window-embedded-tl,
.z-window-embedded-tr {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-corner.gif')});
}
.z-window-popup-tl,
.z-window-popup-tr {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-pop-corner.gif')});
}
.z-window-modal-hr,
.z-window-highlighted-hr,
.z-window-overlapped-hr,
.z-window-popup-hr {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-ol-hr.gif')});
}
.z-window-embedded-hr,
.z-window-embedded-hr-noborder {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-hr.gif')});
}
.z-window-popup-hr {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-pop-hr.gif')});
}
.z-window-modal-hl,
.z-window-highlighted-hl,
.z-window-overlapped-hl,
.z-window-popup-hl {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-ol-hl.gif')});
}
.z-window-embedded-hl,
.z-window-embedded-hl-noborder {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-hl.gif')});
}
.z-window-popup-hl {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-pop-hl.gif')});
}
.z-window-modal-hm,
.z-window-highlighted-hm,
.z-window-overlapped-hm,
.z-window-popup-hm {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-ol-hm.gif')});
}
.z-window-embedded-hm,
.z-window-embedded-hm-noborder {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-hm.gif')});
}
.z-window-popup-hm {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-pop-hm.gif')});
}
.z-window-modal-cl,
.z-window-highlighted-cl,
.z-window-overlapped-cl,
...
.z-window-highlighted-cr,
.z-window-overlapped-cr {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/wnd/wnd-ol-clr.gif')});
}

.z-msgbox-question {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/msgbox/question-btn.gif')});
}
.z-msgbox-exclamation {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/msgbox/warning-btn.gif')});
}
.z-msgbox-information {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/msgbox/info-btn.gif')});
}
.z-msgbox-error {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/msgbox/stop-btn.gif')});
}
</c:if>
