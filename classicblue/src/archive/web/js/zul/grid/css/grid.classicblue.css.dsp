...
div.z-grid-header .z-column-sort-asc, div.z-grid-header .z-column-sort-dsc {
	...
	background-image:url(${c:encodeURL('~./zul/img/classicblue/grid/column-over.png')});
}
...
tr.z-group {
	...
	background-image:url(${c:encodeURL('~./zul/img/classicblue/grid/group_bg.gif')});
}
td.z-group-inner {
	padding: 2px; overflow: hidden;
...
.z-groupfoot {
	background: #E9F2FB repeat-x 0 0;
	background-image:url(${c:encodeURL('~./zul/img/classicblue/grid/groupfoot_bg.gif')});
}
...
.z-column-btn {
	...
	cursor: pointer;
	background-image: url(${c:encodeURL('~./zul/img/classicblue/grid/hd-btn.png')});
}
...
.z-columns-menu-grouping .z-menu-item-img {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/grid/menu-group.png')});
}
.z-columns-menu-asc .z-menu-item-img {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/grid/menu-arrowup.png')});
}
.z-columns-menu-dsc .z-menu-item-img {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/grid/menu-arrowdown.png')});
}
<%-- ZK Column's sizing --%>
...
.z-columns-menu-grouping .z-menu-item-img {
	background-image:  url(${c:encodeURL('~./zul/img/classicblue/grid/menu-group.gif')});
}
.z-columns-menu-asc .z-menu-item-img {
	background-image:  url(${c:encodeURL('~./zul/img/classicblue/grid/menu-arrowup.gif')});
}
.z-columns-menu-dsc .z-menu-item-img {
	background-image:  url(${c:encodeURL('~./zul/img/classicblue/grid/menu-arrowdown.gif')});
}
