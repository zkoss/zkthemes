...
.z-menubar-hor .z-menu-body-clk .z-menu-inner-m  div {
	...
	background-image:url(${c:encodeURL('~./zul/img/classicblue/menu/btn-arrow.gif')});
}
.z-menubar-hor .z-menu-body-clk .z-menu-inner-m  div,
...
.z-menu-item-body-over .z-menu-item-inner-r {
	...
	background-image : url(${c:encodeURL('~./zul/img/classicblue/menu/menu-btn.png')});
}
.z-menu-body-over .z-menu-inner-r,
.z-menu-body-seld .z-menu-inner-r,
.z-menu-item-body-over .z-menu-item-inner-r {
...
.z-menubar-hor .z-menu-body-over .z-menu-inner-m  div {
	...
	background-image:url(${c:encodeURL('~./zul/img/classicblue/menu/btn-menu-hor-over.gif')});
}
.z-menubar-ver .z-menu-body-over .z-menu-inner-m  div {
	background: transparent no-repeat right 0;
	background-image:url(${c:encodeURL('~./zul/img/classicblue/menu/btn-menu-ver-over.gif')});
}
--%>
...
.z-menu-popup {
	...
	padding:2px;
	z-index:88000;
	background-image : url(${c:encodeURL('~./zul/img/classicblue/menu/pp-bg.png')});
	left: 0;
	top: 0;
}
...
.z-menu-popup-cnt .z-menu .z-menu-cnt-img {
	...
	background-image:url(${c:encodeURL('~./zul/img/classicblue/menu/arrow.gif')});
}
<%--define checked menuitem effect in menupopup --%>
.z-menu-popup-cnt .z-menu-item-cnt-ck .z-menu-item-img {
	background:transparent no-repeat center center;
	background-image:url(${c:encodeURL('~./zul/img/classicblue/menu/checked.gif')});
}
.z-menu-popup-cnt .z-menu-item-cnt-unck .z-menu-item-img {
	background:transparent no-repeat center center;
	background-image:url(${c:encodeURL('~./zul/img/classicblue/menu/unchecked.gif')});
}
...
.z-menu-popup-cnt .z-menu-item-over{
	...
	background-image:url(${c:encodeURL('~./zul/img/classicblue/menu/item-over.png')});
}
