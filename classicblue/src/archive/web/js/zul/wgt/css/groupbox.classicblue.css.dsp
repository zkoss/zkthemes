...
.z-groupbox-tr {
	...
	background-image:url(${c:encodeURL('~./zul/img/classicblue/groupbox/groupbox-corner.png')});
	font-size:0;
	height:5px;
	line-height:0;
	margin-right:5px;
...
.z-groupbox-hl {
	...
	background-image:url(${c:encodeURL('~./zul/img/classicblue/groupbox/groupbox-hl.png')});
...
.z-groupbox-hr {
	...
	background-image:url(${c:encodeURL('~./zul/img/classicblue/groupbox/groupbox-hr.png')});
	padding-right:6px;
	zoom: 1;
}
.z-groupbox-hm {
	background:transparent repeat-x 0 0;
	background-image:url(${c:encodeURL('~./zul/img/classicblue/groupbox/groupbox-hm.png')});
	overflow:hidden;
	zoom: 1;
}
.z-groupbox-hm {
...
.z-groupbox-tl {
	background-image:url(${c:encodeURL('~./zul/img/classicblue/groupbox/groupbox-corner.gif')});
}
.z-groupbox-tr{
	background-image:url(${c:encodeURL('~./zul/img/classicblue/groupbox/groupbox-corner.gif')});
}
...
.z-groupbox-hl {
	background-image:url(${c:encodeURL('~./zul/img/classicblue/groupbox/groupbox-hl.gif')});
}
.z-groupbox-hr {
	background-image:url(${c:encodeURL('~./zul/img/classicblue/groupbox/groupbox-hr.gif')});
}
.z-groupbox-hm {
	background-image:url(${c:encodeURL('~./zul/img/classicblue/groupbox/groupbox-hm.gif')});
}
</c:if>