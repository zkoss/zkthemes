...
.z-shadow .z-shadow-cl{
	...
	background-image: url(${c:encodeURL('~./zul/img/classicblue/shadow-cl.png')});
	padding-left: 6px;
	overflow: hidden;
	height:100%;
	zoom: 1;
...
.z-shadow .z-shadow-cr{
	...
	background-image: url(${c:encodeURL('~./zul/img/classicblue/shadow-cr.png')});
	padding-right: 6px;
	overflow: hidden;
	height:100%;
	zoom: 1;
...
.z-shadow .z-shadow-cm {
	...
	background-image: url(${c:encodeURL('~./zul/img/classicblue/shadow-m.png')});
	overflow: hidden;
	height:100%;
	zoom: 1;
}
...
.z-shadow .z-shadow-tl,
.z-shadow .z-shadow-tr{
	background-image:url(${c:encodeURL('~./zul/img/classicblue/shadow-tlr.png')});
}

.z-shadow .z-shadow-bl,
.z-shadow .z-shadow-br{
	background-image:url(${c:encodeURL('~./zul/img/classicblue/shadow-blr.png')});
}
...
span.z-drop-allow {
	...
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/drag.png')});
}
...
div.z-drop-cnt {
	width: 120px;
	height: 18px;
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/drop-bg.gif')});
	padding: 2px;
	font-size: ${fontSizeM};
	font-weight: normal;
	font-family: ${fontFamilyC};
...
.z-upload-icon {
	overflow: hidden;
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/prgmeter.png')});
}
...
.z-fileupload-add {
	...
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/fileupload.gif')});
	width: 16px;
	height: 17px;
}
--%>
...
span.z-drop-allow,
span.z-drop-disallow {
	background-image: url(${c:encodeURL('~./zul/img/classicblue/misc/drag.gif')});
}
</c:if><%-- IE6 --%>
</c:if><%--IE --%>
